...
updateStreet newStreet address = { street: newStreet, city: address.city }
...
listHighPointStoryIds stories = map _.objectID $ Array.filter hasOver100Points stories
  where
  hasOver100Points :: Story -> Boolean
  hasOver100Points s = s.points > 100

philStories :: Array Story -> Array Story
philStories stories = Array.filter isPhilStory stories
  where
  isPhilStory story = story.author == "paf31"
